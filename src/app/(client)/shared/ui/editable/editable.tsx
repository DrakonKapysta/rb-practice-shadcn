...
import { VisuallyHiddenInput } from '@/app/(client)/shared/ui/visually-hidden-input/visually-hidden-input'
import { useComposedRefs } from '@/pkg/libraries/ui/compose-refs'
...
function EditableRoot(props: EditableRootProps) {
  const { value, defaultValue, defaultEditing, editing, onValueChange, onEditingChange, ...rootProps } = props
  ...
  return (
    <StoreContext.Provider value={store}>
      <EditableRootImpl value={value} defaultValue={defaultValue} editing={editing} {...rootProps} />
...
function EditableInput(props: EditableInputProps) {
  ...
  const onKeyDown = React.useCallback(
    ...
    [value, context.onSubmit, context.onCancel, context.onEscapeKeyDown, inputProps.onKeyDown, isDisabled, isReadOnly],
  )
